...
This script starts an MCP server providing Google Gemini AI models via stdio.
"""
...
from src.chimera_stdio_mcp.tools.gemini import GeminiTool
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join(project_root, "data", "gemini_mcp.log")),
...
class GeminiMCPServer:
    """MCP server for Google Gemini AI models."""
    ...
    def register_tools(self):
        ...
        self.tools[gemini_tool.TOOL_NAME] = gemini_tool
